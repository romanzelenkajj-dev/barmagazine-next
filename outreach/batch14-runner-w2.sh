#!/bin/bash
# One-shot runner for batch 14 window w2 (armed 2026-09-15, moved 2026-09-16 on Roman's go to Wednesday
# 2026-09-16, 23:00 PT). Asia and India rows from the enrichment apply.
set -u
