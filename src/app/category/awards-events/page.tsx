...
export const metadata: Metadata = {
  title: 'Awards & Events | Bar Magazine',
  description: 'The latest news, awards, and features from the bar and cocktail industry.',
};
...
export default async function AwardsEventsPage({
  ...
  // news (52) + features (40)
  const result = await getPostsByMultipleCategories([52, 40], page, 12);
    ...
    <>
      <div style={{ marginTop: 'var(--gap)' }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-secondary)', marginBottom: 24 }}>
          Industry news, awards, and features
        </p>
        ...
        <div className="cat-filters">
          ...
          <Link href="/category/awards-events" className="cat-filter-btn active">Awards &amp; Events</Link>
        ...
        {result.totalPages > 1 && (
          <div className="pagination">
            {page > 1 && (
              <Link href={`/category/awards-events?page=${page - 1}`}>
