  ...
  return (
    <div style={{ padding: '2rem 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        ...
        <Link href="/admin/bars" style={{ color: '#c47843', textDecoration: 'none', fontSize: 14, fontWeight: 500 }}>
          Manage Bars
        </Link>
      </div>
        ...
        {(['pending', 'approved', 'rejected'] as const).map(t => (
          <button
            ...
            style={{
              ...
              background: tab === t ? (t === 'pending' ? '#c47843' : t === 'approved' ? '#22c55e' : '#666') : '#f0ebe5',
              color: tab === t ? '#fff' : '#666',
            }}
          >
            {t}
          ...
          {submissions.map(s => (
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px 24px', fontSize: 14, color: '#555', marginBottom: 12 }}>
                ...
                {s.website && <div><strong>Website:</strong> <a href={s.website.startsWith('http') ? s.website : `https://${s.website}`} target="_blank" rel="noopener" style={{ color: '#c47843' }}>{s.website}</a></div>}
