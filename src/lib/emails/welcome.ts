...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .email-hero { background-color: #1A1A1A; padding: 0 48px 48px; text-align: center; border-bottom: 3px solid #9B4A2D; }
    ...
    .expect-section { background-color: #F5F0E8; border-left: 3px solid #9B4A2D; padding: 24px 28px; margin: 32px 0; }
    ...
    .expect-dot { width: 6px; height: 6px; background-color: #9B4A2D; border-radius: 50%; margin-top: 8px; margin-right: 12px; flex-shrink: 0; }
    .expect-item p { font-size: 15px; color: #444444; line-height: 1.5; margin-bottom: 0; }
    .cta-wrapper { text-align: center; margin: 36px 0; }
    .cta-button { display: inline-block; background-color: #9B4A2D; color: #FFFFFF !important; font-family: 'Inter', Arial, sans-serif; font-size: 15px; font-weight: 600; letter-spacing: 0; text-decoration: none; padding: 14px 36px; }
    ...
    <div class="email-container">
      ...
      <div class="email-body">
        ...
        <p style="font-size: 14px; color: #888888; text-align: center; margin-bottom: 0;">
          ...
          <a href="https://barmagazine.com/add-your-bar" style="color: #9B4A2D; text-decoration: none; font-weight: 600;">Add your bar for free &rarr;</a>
        </p>
      </div>
